...
const Type = props => (
  <div>
    ...
    <pre dangerouslySetInnerHTML={{__html: Prism.highlight(`<link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Roboto:300,300i,400,400i,500,500i,700,700i|Roboto+Mono:400,400i,500,500i" rel="stylesheet">`, Prism.languages.jsx, 'jsx')}} />
    <h3>Type Scale</h3>
